...
void read24bn() {
    ifstream in;
    in.open("/Users/Yuichi/root/macros/mytext24b.txt");    //Check
    
    Float_t dpT,dphi,deta,dR,invm;      //Values
    Int_t nlines = 0;
    TFile *f = new TFile("read24b.root","RECREATE");    //Output name
    TNtuple *ntuple = new TNtuple("ntuple","data from read24b file","dpT:dphi:deta:dR:invm");    //Values
...
void read24bm() {
    ...
    TFile *f = new TFile("read24b.root");    //root file name
