...
// Tue Dec 29 15:21:30 2015 by ROOT version 6.05/03
// from TTree ttbar/
// found on file: histo-174-2.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("histo-174-2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("histo-174-2.root");
      }
