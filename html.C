...
Bool_t enable_ssl               = kFALSE;
Bool_t enable_sqlite            = kTRUE;
Bool_t enable_table             = kFALSE;
Bool_t enable_thread            = kTRUE;
Bool_t enable_xml               = kTRUE;
Bool_t enable_xrootd            = kFALSE;
